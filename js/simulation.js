...
let btnCreator = function () {
    ...
    for (let i = 1; i <= 121; i++) {
        ...
        if (i == 62) {
            ...
            btnCenter.innerHTML = `<ion-icon name="golf-outline"></ion-icon>`
            btnCenter.style.color = 'green'
            btnCenter.style.fontSize = "x-large"
...
submitBtn.addEventListener('click', async (e) => {
    ...
    if (totClick < 10) {
        ...
        chartHeader.innerText = "Hover the boxes to see the frequency of each box, black circle represents the target"
        ...
        fetch('https://sim-cluster-api.onrender.com/', {
            method: 'POST',
            body: JSON.stringify({
                value: sendValues
            }),
